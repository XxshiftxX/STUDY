...
public class DataManager : MonoBehaviour {
	...
	public ArrayList Gamedata_scriptLine = new ArrayList(); // 게임의 스크립트의 라인이 들어갈 변수
	...
	public void scriptLoad(string script){
		Gamedata_scriptLine.Clear ();
		foreach (string s in Assetdata_scripts[0].text.Split('\n'))
		{
			Gamedata_scriptLine.Add (s);
		}
	}
